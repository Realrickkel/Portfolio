import { BORAIMG, JOYIMG } from "../utils"

const ReviewComponent = () => {
    return (
        <section id='Film-ReviewID' className="">
            <div>
                <h2 className="text-lg title-max-width m-4 border-t-2 border-solid border-l-neutral-900">//Film Review</h2>
                    <div className="screen-max-width flex flex-col p-10">
                        ...
                        justify-between">
                            ...
                            <img src={BORAIMG} alt="PF image" className="rounded-2xl"/>
