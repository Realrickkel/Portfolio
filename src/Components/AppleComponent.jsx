import { JOYIMG, YOOAHIMG } from "../utils"

const AppleComponent = () => {
    return (
        <section id='AppleID' className="">
            <div>
                <h2 className="text-lg title-max-width m-4 border-t-2 border-solid border-l-neutral-900">//Case Study: Apple Website</h2>
                    <div className="screen-max-width flex flex-col p-10">
                        ...
                        justify-between">
                            ...
                            <img src={YOOAHIMG} alt="PF image" className="rounded-2xl"/>
