import { ITZYIMG, JOYIMG } from "../utils"

const JavaScriptGameComponent = () => {
    return (
        <section id='JavascriptGameID' className="">
            <div>
                <h2 className="text-lg title-max-width m-4 border-t-2 border-solid border-l-neutral-900">//Javascript Game</h2>
                    <div className="screen-max-width flex flex-col p-10">
                        ...
                        justify-between">
                            ...
                            <img src={ITZYIMG} alt="PF image" className="rounded-2xl"/>
