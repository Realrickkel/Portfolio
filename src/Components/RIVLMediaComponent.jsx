...
import { BORAIMG, COMPEQUIPIMG, CSSIMG, HTMLIMG, ITZYIMG, JOYIMG, JSIMG, RIVLMEDIABANNERIMG, RIVLMEDIASEOIMG } from "../utils"
                        ...
                        <div className="common-padding !px-0 flex flex-row">
                            <div id="" className="max-w-[60%]">
                                ...
                                <div className="flex flex-row justify-between">
                                    <div className="flex flex-row justify-normal mt-5 gap-8">
                                        <div className="">
                            ...
                            <div className="flex flex-col max-w-[25%] mx-auto justify-center">
                                <img src={COMPEQUIPIMG} alt="PF image" className="rounded-2xl"/>
                            ...
                            <div id="Design" className="common-padding !px-0 flex flex-row justify-between items-start h-100%">
                                <div id="" className="max-w-[15%] sticky top-2">
                                    <div className="relative">
                                        <h2 className="text-4xl font-bold absolute opacity-0 z-10 text_light">Design</h2>
                                        <h2 className="text-4xl font-bold text-gray-500 absolute text_dark">Design</h2>
                                    </div>
                                </div>
                                <div className="flex flex-col max-w-[80%]">
                                    <div className="my-4">
                                        <img src={RIVLMEDIABANNERIMG} alt="PF image" className="rounded-2xl i_fade"/>
                            ...
                            <div id="UX/UI" className="common-padding !px-0 flex flex-row justify-between items-start h-100%">
                                <div id="" className="max-w-[15%] sticky top-2">
                                    <div className="relative">
                                        <h2 className="text-4xl font-bold absolute opacity-0 z-10 text_light">UX/UI</h2>
                                        <h2 className="text-4xl font-bold text-gray-500 absolute text_dark">UX/UI</h2>
                                    </div>
                                </div>
                                <div className="flex flex-col max-w-[80%]">
                                    <div className="my-4" >
                            ...
                            <div id="SEO" className="common-padding !px-0 flex flex-row justify-between items-start h-100%">
                                <div id="" className="max-w-[15%] sticky top-2">
                                    <div className="relative">
                                        <h2 className="text-4xl font-bold absolute opacity-0 z-10 text_light">SEO</h2>
                                        <h2 className="text-4xl font-bold text-gray-500 absolute text_dark">SEO</h2>
                                    </div>
                                </div>
                                <div  className="flex flex-col max-w-[80%]">
                                    <div className="my-4">
                                        <img src={RIVLMEDIASEOIMG} alt="PF image" className="rounded-2xl i_fade"/>
                                        <h2 className="text-xl font-bold mt-2">Technische Optimalisaties:  </h2>
                                        <p className="text-sm">We hebben de laadsnelheid verhoogd door bestanden te comprimeren, caching toe te passen en onnodige scripts te verwijderen. Ook is de site-structuur verbeterd, wat niet alleen gebruikers maar ook zoekmachines helpt om de inhoud beter te begrijpen.</p>
                                    </div>

                                    <div className="my-4">
                                        <img src={RIVLMEDIABANNERIMG} alt="PF image" className="rounded-2xl i_fade"/>
                                        <h2 className="text-xl font-bold mt-2">Gerichte Contentstrategie  </h2>
                                        <p className="text-sm">Door uitgebreid zoekwoordonderzoek hebben we bepaald welke termen de doelgroep van RIVL Media gebruikt. Vervolgens zijn deze geïntegreerd in de tekst, meta-titels, en beschrijvingen zonder afbreuk te doen aan de leesbaarheid en kwaliteit van de content.</p>
                                    </div>
